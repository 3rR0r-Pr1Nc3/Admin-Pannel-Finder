...
print "\t+-----------------------------------------+\n";
print "\n";
print "* info : Webadmin scan Loaded% ...\n ";
print "[!] Put Site to scan - Please entre full path :!?\n\n>>>> ";
$site=<STDIN>;
chomp $site;

print "\n";
print ">>>> The results will be save in text file do you wana save this file? y/n ";
$save=<STDIN>;
chomp $save;

print "\n";
print "* Info : Source code site type?\n\n a = php\n b = asp\n c = aspx\n d = cfm\n e = js\n f = cgi\n g = brf\n h = Intense\n-> ";
$code=<STDIN>;
chomp($code);
...
print ">>> Target: $site\n";
print ">>> URL source code: $code\n";
print ">>> Cheking for  admin db...\n\n\n";
